...
function luckysheetMoveHighlightCell(postion, index, type, isScroll) {
  ...
  if (type == "rangeOfSelect") {
    ...
    if (margeset2) {
      ...
      row = Store.visibleRowPositions[moveX];
      row_pre = moveX - 1 == -1 ? 0 : Store.visibleRowPositions[moveX - 1];
      // row_index = moveX;
      // row_index_ed = moveX;
...
function luckysheetMoveHighlightCell2(postion, type, isScroll) {
  ...
  if (type == "rangeOfSelect") {
    ...
    row = Store.visibleRowPositions[rf];
    row_pre = rf - 1 == -1 ? 0 : Store.visibleRowPositions[rf - 1];
