...
export function initColHeaderEvents() {
        ...
        if (formula.rangestart || formula.rangedrag_column_start || formula.rangedrag_row_start || formula.israngeseleciton() || formulaDialogs.ifFormulaMultiRange.isVisible()) {
          ...
          if (event.shiftKey) {
            ...
            if (vText !== null && vText.substr(0, 1) == "=") {
              ...
              richTextEditor.innerHTML = vText;
    ...
    colHeader.onMouseup(function (event) {
      if (event.which == 3) {
        ...
        const _elAdd2 = document.getElementById("luckysheet-cols-rows-add"); if (_elAdd2) _elAdd2.style.display = 'block';
        const _elData2 = document.getElementById("luckysheet-cols-rows-data"); if (_elData2) _elData2.style.display = 'block';
